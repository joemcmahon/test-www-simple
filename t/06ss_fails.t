...
@expected = map {"$_\n"} split /\n/,<<EOF;
1..4
not ok 1 - No python on perl.org [http://perl.org/]
not ok 2 - No perl on python.org [http://python.org/]
not ok 3 - Python on python.org [http://python.org/]
not ok 4 - Perl on perl.org [http://perl.org/]
EOF
